...
var HeaderCell = Backgrid.HeaderCell = Backbone.View.extend({
  ...
  */
  ...
  direction: function (dir) {
    if (arguments.length) {
      ...
      if (dir) {
          if (dir === "ascending") {
            this.$el.find("a").append("<b class='fa fa-sort-down right-icon'></b>");
          } else {
              if (dir === "descending") {
                this.$el.find("a").append("<b class='fa fa-sort-up right-icon'></b>");
              }
          }
      } else {
        this.$el.find("a").append("<b class='fa fa-sort right-icon'></b>");
      }
  ...
  */
  ...
  render: function () {
    this.$el.empty();
    var $label = $("<a>").text(this.column.get("label")).append("<b class='fa fa-sort right-icon'></b>");
